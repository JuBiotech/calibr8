...
.. toctree::
   ...
   notebooks/Basic_ExponentialModel
   notebooks/Basic_GeneralizedLogistic
   notebooks/Example_Fitting_a_Linear_Model
   notebooks/Example_Numeric_Independent_Posterior
   notebooks/Advanced_In-depth_Model_Fitting
   notebooks/Advanced_Custom_Noise_Models
   notebooks/Advanced_Hierarchical_Calibration
